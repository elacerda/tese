...
galáxias resultantes da seleção  {\ATR de zonas em discos $R > 0.7 HLR$ e onde SN $>3$ ??EM QUE LINHA(S)??\ojo} . Em cada gráfico temos os valores da média, mediana, desvio padrão,
