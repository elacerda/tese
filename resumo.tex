...
\begin{enumerate*}[label=(\roman*)]
  \item a componente hDIG é prevalente entre galáxias elípticas, S0 e também em bojos, além de explicar a distribuição bimodal de $W_{\Ha}$, tanto \ED{dentro} quanto entre galáxias;
