...
Como visto, a contribuição fracional da luminosidade de \Ha para diferentes partes em galáxias expandido todos os tipos de Hubble não pode ser negligenciada. Porém os diferentes regimes de ionização alteram também outras linhas de emissão, fazendo com que a contribuição de cada região para cada linha seja diferente.
