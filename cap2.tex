...
%descrever a fonte empírica do nosso trabalho, os espectros observados todas as características da amostra utilizada para nosso estudo, que faz parte do DR3 do CALIFA.
...
A Figura \ref{fig:DR2} exemplifica parte de nossa análise. Essa figura, aqui reproduzida, está publicada no artigo \citet{GarciaBenito.etal.2015a}. Nela vemos
